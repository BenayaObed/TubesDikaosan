...
public class Orders {
    ...
    private CustomerAddress address_id;
    ...
    public Orders(Integer order_id, String notes, Users user_id, CustomerAddress address_id, Payment payment_id,
    ...
    public CustomerAddress getAddress_id() {
        return address_id;
    }

    public void setAddress_id(CustomerAddress address_id) {
        this.address_id = address_id;
    }
