            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-6">
                    <a href="#" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Add Category</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <c:forEach items="${categories}" var="category">
                    <tr>
                      ...
                      <td>
                        <a href="${category.category_id}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
