  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/dashboard/css/adminlte.min.css">
  <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/dashboard/css/style.css">
